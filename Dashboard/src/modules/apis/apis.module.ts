...
export class ApisModule {
    constructor( @Optional() @SkipSelf() parentModule: ApisModule) {
        if (parentModule) {
            throw new Error(`${ApisModule.name} is already loaded. Import it in your application's root module only.`);
        }
    }
}
