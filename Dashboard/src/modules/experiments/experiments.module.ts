...
export class ExperimentsModule {
  constructor( @Optional() @SkipSelf() parentModule: ExperimentsModule) {
    if (parentModule) {
      throw new Error(`${ExperimentsModule.name} is already loaded. Import it in your application's root module only.`);
    }
  }
}
