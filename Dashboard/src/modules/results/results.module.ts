...
export class ResultsModule {
  constructor( @Optional() @SkipSelf() parentModule: ResultsModule) {
    if (parentModule) {
      throw new Error(`${ResultsModule.name} is already loaded. Import it in your application's root module only.`);
    }
  }
}
